export const formatVideoTime = (totalSeconds: number): string => {
  ...
  // (e.g. 1.4 + 0.2 === 1.5999999999999999, which means it displays 00:00:01.5
  // instead of 00:00:01.6). It has downsides but it's simple and only 1 line of
  // code.
  // Another possible solution would be to store time as tenth-seconds so that
  // we would be working with integers and wouldn't have floating-point
  // addition.
